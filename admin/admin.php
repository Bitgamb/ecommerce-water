            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index.html">
                            <img class="img-fluid" src="../images/sselogo.png" alt="Theme-Logo" />
                        </a>
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.other">Users Feedback/Queary</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="#">
                                        <span class="pcoded-micon"><i class="ti-direction-alt"></i><b>M</b></span>
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.other">Recorts</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="#">
                                        <span class="pcoded-micon"><i class="ti-direction-alt"></i><b>M</b></span>
